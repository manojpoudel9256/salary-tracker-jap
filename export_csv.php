...
<div class="container mt-5 text-center">
    ...
    <div class="alert alert-info">
        Your salary data is being exported as a CSV file. The download should start automatically. If not, <a href="export_csv.php" class="alert-link">click here to download the file manually.</a>
    </div>
