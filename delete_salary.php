...
<div class="container mt-5">
    ...
    本当に<strong><?= htmlspecialchars($salary['store_name']) ?></strong>の給与記録（金額: <strong>¥<?= number_format($salary['amount']) ?></strong>、受領日: <strong><?= htmlspecialchars($salary['received_date']) ?></strong>）を削除してもよろしいですか？
</div>
