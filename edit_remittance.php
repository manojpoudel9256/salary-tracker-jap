...
$trans = [
    'en' => [
        ...
        'subtitle' => 'Update transfer record',
        'created' => 'Created',
        'amount' => 'Amount (¥)',
        ...
        'error_db' => 'Error updating record: '
    ],
    'jp' => [
        'title' => '送金記録の編集',
        'subtitle' => '送金記録を更新',
...
<body>
    <div class="container">
        ...
        <div class="page-header">
            <a href="view_remittance.php" class="back-btn"><i class="fas fa-arrow-left"></i></a>
        ...
        <div class="created-badge">
            ...
            <?= $t['created'] ?>: <?= date('Y/m/d', strtotime($remittance['created_at'])) ?>
        </div>
        ...
        <form method="post" class="form-card">
            ...
            <div class="field-group">
                ...
                <input type="number" name="amount" id="amount" class="field-input"
                    placeholder="<?= $t['amount_placeholder'] ?>" value="<?= $remittance['amount'] ?>" required>
            ...
            <div class="field-group">
                ...
                <input type="date" name="date_sent" id="date_sent" class="field-input"
            ...
            <div class="field-group">
                ...
                <input type="text" name="recipient" id="recipient" class="field-input"
                    placeholder="<?= $t['recipient_placeholder'] ?>" maxlength="100"
                    value="<?= htmlspecialchars($remittance['recipient']) ?>" autocomplete="off">
            ...
            <div class="field-group">
                ...
                <textarea name="purpose" id="purpose" rows="3" class="field-input"
                    placeholder="<?= $t['purpose_placeholder'] ?>"><?= htmlspecialchars($remittance['purpose']) ?></textarea>
            </div>
